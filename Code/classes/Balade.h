...
public:
   ...
   * Empty Constructor
   */
  Balade (unsigned int depart, unsigned int arrivee);
...
private:
  ...
  unsigned int date_depart;
  unsigned int date_fin;
public:
...
public:
   ...
   */
  void setDate_depart ( unsigned int new_var )   {
      date_depart = new_var;
  }
   ...
   */
  void setDate_fin ( unsigned int new_var )   {
      date_fin = new_var;
  }
